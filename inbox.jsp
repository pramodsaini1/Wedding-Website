<%-- 
    Document   : inbox
    Created on : 26 Feb, 2023, 4:04:36 PM
    Author     : Genius
--%>
                                ...
                                <div class="row w3-card-4"  style="background-color:white">
                                    ...
                                    <div class="col-sm-12"><br><br></div>
                                     <%
                                            ...
                                            ResultSet rs1 = st1.executeQuery("select * from msg where temail='"+email+"'");
                                            while(rs1.next()){
                                                String f_email = rs1.getString("femail");
                                                Statement st2 = cn.createStatement();
                                                ResultSet rs2 = st2.executeQuery("select * from register where email='"+f_email+"'");
                                                while(rs2.next()){
                                      %>
                                    <div class="col-sm-4">                                             
                                        <a href="msg.jsp?code=<%=rs2.getString("code")%>">
                                            <img src="Profile/<%=rs2.getString("code")%>.jpg" style="width:100px;height:100px;" class="img-fluid">
                                            <h4 style="font-family:arial"><%=rs2.getString("fname")%>&nbsp;&nbsp;<%=rs2.getString("lname")%></h4>
                                        </a>
                                    </div>
                                    <div class="col-sm-8">
                                         <table class="table table-borderless">
                                             <tr><td>Message :</td><td><%=rs1.getString("msg")%></td></tr>
                                             <tr><td>Date :</td><td><%=rs1.getString("dt")%></td></tr>
                                         </table>
                                    </div><br><br><br>
                                    <div class="col-sm-12"><br><br></div>
                                                           <%
