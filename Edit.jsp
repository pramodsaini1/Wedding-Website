<%-- 
    Document   : Edit
    Created on : 25 Feb, 2023, 4:59:53 PM
    Author     : Genius
--%>
                                    ...
                                    <div class="col-sm-8">
                                        <form method="post" action="update_profile.jsp">
                                            <table class="table table-hover table-borderless">
                                                <tr><td>First Name :</td><td style="width:5px">:</td> </td><td><input type="text" name="fname" class="form-control" value="<%=rs.getString("fname")%>"></td></tr>
                                               <tr><td>Last Name :</td><td>:</td> </td><td><input type="text" name="lname" class="form-control" value="<%=rs.getString("lname")%>"></td></tr>
                                                <tr><td>Date Of Birth</td><td>:</td> </td><td><input type="date" name="dob" class="form-control" value="<%=rs.getString("dob")%>"></td></tr>
                                                <tr><td>Gender</td><td>:</td> </td><td><select name="gender" class="form-control"><option value="<%=rs.getString("gender")%>"><%=rs.getString("gender")%></option><option value="male">Male</option><option value="female">Female</option></select></td></tr>
                                                <tr><td>Caste</td><td>:</td></td><td>
