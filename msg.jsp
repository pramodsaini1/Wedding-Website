<%-- 
    Document   : msg.jsp
    Created on : 26 Feb, 2023, 8:25:15 AM
    Author     : Genius
--%>
        ...
        if(rs.next()){
            if(request.getParameter("code")!=null){
                String code = request.getParameter("code");
                 ...
                 ResultSet rs1 = st1.executeQuery("select * from register where code='"+code+"'");
                 if(rs1.next()){
                     %>
                     <!DOCTYPE html>
<html>
            ...
            <div class="row"  style="background-image:url(images/back.png);height:auto;">
                <div class="col-sm-12">
                        ...
                        <div class="row" style="margin-top:100px">
                            ...
                            <div class="col-sm-8">
                              ...
                              if(request.getParameter("empty")!=null){
                                  ...
                                  out.println("<div class='alert alert-danger'>Message Sent SuccessFully</div>");
                              }
					...
					<img src="Profile/<%=rs1.getString("code")%>.jpg" class="img-fluid">
                                    ...
                                    <div class="col-sm-8">
                                        <form method="post" action="msg_send.jsp?code=<%=code%>">
                                        <table class="table table-hover table-borderless">
                                           ...
                                           <tr><td>Last Name :</td><td>:</td> </td><td><%=rs1.getString("lname")%></td></tr>
                                            ...
                                            <tr><td>Message</td><td>:</td><td><textarea name="msg" class="form-control"></textarea></td></tr>
                                            <tr><td><input type="submit" value="Send Msg" class="btn btn-success"></td></tr>
                                        </table>
				   </div>
                                </div>
                                       <div class="col-sm-12"><br><br></div>
