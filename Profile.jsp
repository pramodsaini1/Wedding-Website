<%-- 
    Document   : Profile
    Created on : 25 Feb, 2023, 9:10:44 AM
    Author     : Genius
--%>
...
font-family: 'Texturina';font-size: 22px;	
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <a class="nav-link" style="cursor:pointer;color:white" href="contact.jsp">Contact</a>
      </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="row" style="margin-top:100px">
                            ...
                            <div class="col-sm-8">
                              ...
                              if(request.getParameter("empty")!=null){
                                  ...
                                  out.println("<div class='alert alert-danger'>Record Updated</div>");
                              }
					...
					<img src="Profile/<%=rs.getString("code")%>.jpg" class="img-fluid">
                                    ...
                                    <div class="col-sm-8">
                                        <table class="table table-hover table-borderless">
                                            <tr><td>First Name :</td><td style="width:5px">:</td> </td><td><%=rs.getString("fname")%></td></tr>
                                           <tr><td>Last Name :</td><td>:</td> </td><td><%=rs.getString("lname")%></td></tr>
